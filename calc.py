...
CEO_CALCS = {
    ...
    "ebitda": {
        "name": "EBITDA (прибыль до вычета процентов, налогов и амортизации)",
    ...
    "roi": {
        ...
        "advice": "1. Рассчитывайте ROI до начала инвестиций\n2. Сравнивайте ROI разных проектов\n3. Инвестируйте только в проекты с ROI > 30%",
        "problems": "❌ Инвестиции без расчёта окупаемости\n❌ Нет системы оценки проектов\n❌ Деньги вложены неэффективно"
    },
    "debt_ratio": {
        "name": "Коэффициент долговой нагрузки",
        "inputs": ["Общий долг (руб)", "EBITDA (руб)"],
        "formula": "a / b",
        "interpretation": "Показывает, сколько лет потребуется, чтобы погасить долг за счёт текущей прибыли.",
        "advice": "1. Сократите долг\n2. Увеличьте EBITDA\n3. Рефинансируйте дорогие кредиты",
        "problems": "❌ Долг превышает 3 EBITDA\n❌ Высокие проценты по кредитам\n❌ Нет плана погашения долга"
    }
}
...
SALES_CALCS = {
    ...
    "pipeline": {
        "name": "Средняя скорость сделки (воронка)",
...
LOGISTICS_CALCS = {
    ...
    "fill_rate": {
        "name": "Уровень выполнения заказов (Fill Rate)",
    ...
    "warehouse_cost": {
        "name": "Себестоимость хранения 1 единицы товара",
...
PRODUCTION_CALCS = {
    "oee": {
        "name": "Общая эффективность оборудования (OEE)",
...
PROJECT_CALCS = {
    "spi": {
        ...
        "formula": "a / b",
        "interpretation": "SPI > 1 — проекты выполняются быстрее плана, < 1 — отстают.",
    ...
    "cpi": {
        ...
        "formula": "a / b",
        "interpretation": "CPI > 1 — бюджет перерасходуется, < 1 — экономия.",
...
LEGAL_CALCS = {
    ...
    "compliance": {
        "name": "Уровень соблюдения требований (Compliance)",
